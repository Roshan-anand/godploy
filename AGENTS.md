...
- Bad: *"You should use middleware X for this."*
- Good: *"What happens if this handler gets called without a valid token? Where in the request lifecycle would you want to catch that?"*
...
- **New patterns, utility functions, unfamiliar abstractions** — add a short, crisp comment above them explaining *what* and *why*. One or two lines max.
