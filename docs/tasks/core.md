...
- [x] 13 — Preserve deleted database data as an Orphan Volume and show it in Storage [easy]
- [x] 14 — Reattach a compatible Orphan Volume during Predefined Database Service creation [easy]
